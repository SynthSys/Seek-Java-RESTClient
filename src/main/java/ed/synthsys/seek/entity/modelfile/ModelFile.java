...
public class ModelFile implements Serializable {
    ...
    private static final long serialVersionUID = 4409827812564928843L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ModelFile) == false) {
            return false;
        }
        ModelFile rhs = ((ModelFile) other);
    ...
    public void setAssayId(String assayId) {
        ModelFileData data = this.getData();
        ModelFileRelationships rels = data.getRelationships();
