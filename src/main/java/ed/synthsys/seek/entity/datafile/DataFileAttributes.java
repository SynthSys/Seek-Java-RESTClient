...
import ed.synthsys.seek.entity.common.ContentBlob;
...
public class DataFileAttributes implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataFileAttributes) == false) {
            return false;
        }
        DataFileAttributes rhs = ((DataFileAttributes) other);
