...
public class SeekRestApiCollectionResponse {

    @JsonProperty("data")
    private List<ApiResponseDatum> data = null;
    ...
    @JsonProperty("data")
    public List<ApiResponseDatum> getData() {
        return data;
    }

    @JsonProperty("data")
    public void setData(List<ApiResponseDatum> data) {
        this.data = data;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SeekRestApiCollectionResponse) == false) {
            return false;
        }
        SeekRestApiCollectionResponse rhs = ((SeekRestApiCollectionResponse) other);
