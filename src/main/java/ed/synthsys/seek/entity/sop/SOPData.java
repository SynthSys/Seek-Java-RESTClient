...
public class SOPData {
    ...
    private SOPAttributes attributes;
    ...
    @JsonProperty("attributes")
    public SOPAttributes getAttributes() {
        return attributes;
    }

    @JsonProperty("attributes")
    public void setAttributes(SOPAttributes attributes) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SOPData) == false) {
            return false;
        }
        SOPData rhs = ((SOPData) other);
