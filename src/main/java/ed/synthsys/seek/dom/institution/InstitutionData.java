package ed.synthsys.seek.dom.institution;
...
public class InstitutionData {
    ...
    private InstitutionAttributes attributes;
    @JsonIgnore
    ...
    @JsonProperty("attributes")
    public InstitutionAttributes getAttributes() {
        return attributes;
    }

    @JsonProperty("attributes")
    public void setAttributes(InstitutionAttributes attributes) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof InstitutionData) == false) {
            return false;
        }
        InstitutionData rhs = ((InstitutionData) other);
