package ed.synthsys.seek.dom.programme;
...
public class ProgrammeData {
    ...
    private ProgrammeAttributes attributes;
    ...
    @JsonProperty("attributes")
    public ProgrammeAttributes getAttributes() {
        return attributes;
    }

    @JsonProperty("attributes")
    public void setAttributes(ProgrammeAttributes attributes) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProgrammeData) == false) {
            return false;
        }
        ProgrammeData rhs = ((ProgrammeData) other);
